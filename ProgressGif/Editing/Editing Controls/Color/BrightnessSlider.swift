...
//    func handleOpacityChanged(slider: BrightnessSlider)
//}
//
...
//    }
//    
//    var sliderType = SliderType.brightnessSlider
//    
...
//            
//            if sliderType == .brightnessSlider {
...
//            } else {
////                let alpha = CGFloat(i) * 1 / CGFloat(scales.count)
////                let color = hsColor.with(brightness: alpha)
////                scale.backgroundColor = color.uiColor.cgColor
////                let color = hsColor.
//            }
//        }
...
//        } else {
//            delegate?.handleOpacityChanged(slider: self)
//        }
//    }
//}
