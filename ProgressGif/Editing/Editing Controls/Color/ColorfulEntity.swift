...
//
//extension HSColor {
//    func with(brightness: CGFloat, alpha: CGFloat? = nil) -> HSVColor {
//        return HSVColor(colorSpace: colorSpace, hue: hue, saturation: saturation, brightness: brightness, alpha: alpha)
//    }
//    
//}
