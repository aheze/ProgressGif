...
struct ANSegmentIndicatorSettings {
    ...
    var spaceBetweenSegments: Degrees = 4
...
class ANSegmentIndicator: UIView {
    ...
    private var segments: [CAShapeLayer] = [] //array of dynamic segments
    private var staticSegments: [CAShapeLayer] = [] //array of static segments
    private var value: Radians = 0.0 //current value of progress bar in percents from 0 to 1
    private var activeSegment: Int = 0 //current animated segment shape index
    
    //redraw indicator logic
